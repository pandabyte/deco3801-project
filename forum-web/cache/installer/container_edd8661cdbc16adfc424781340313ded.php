...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    /**
     * Gets the public 'installer.obtain_data.obtain_imagick_path' shared service.
     *
     * @return \phpbb\install\module\obtain_data\task\obtain_imagick_path
     */
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005847de8900000000236238f0(
...
class phpbbtemplatetwiglexer_000000005847de8900000000236238f0 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b87d3073b6cd466078967 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b87d3073b6d2477072690 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b87d3073b6bd851848996 = array(
    ...
    {
        $this->initializer5b87d3073b6d2477072690 && ($this->initializer5b87d3073b6d2477072690->__invoke($valueHolder5b87d3073b6cd466078967, $this, 'set_environment', array('env' => $env), $this->initializer5b87d3073b6d2477072690) || 1) && $this->valueHolder5b87d3073b6cd466078967 = $valueHolder5b87d3073b6cd466078967;

        return $this->valueHolder5b87d3073b6cd466078967->set_environment($env);
    }
    ...
    {
        $this->initializer5b87d3073b6d2477072690 && ($this->initializer5b87d3073b6d2477072690->__invoke($valueHolder5b87d3073b6cd466078967, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b87d3073b6d2477072690) || 1) && $this->valueHolder5b87d3073b6cd466078967 = $valueHolder5b87d3073b6cd466078967;

        return $this->valueHolder5b87d3073b6cd466078967->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b87d3073b6d2477072690 && ($this->initializer5b87d3073b6d2477072690->__invoke($valueHolder5b87d3073b6cd466078967, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b87d3073b6d2477072690) || 1) && $this->valueHolder5b87d3073b6cd466078967 = $valueHolder5b87d3073b6cd466078967;

        return $this->valueHolder5b87d3073b6cd466078967->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b87d3073b6d2477072690 = $initializer;
    }
    ...
    {
        $this->initializer5b87d3073b6d2477072690 && ($this->initializer5b87d3073b6d2477072690->__invoke($valueHolder5b87d3073b6cd466078967, $this, '__get', array('name' => $name), $this->initializer5b87d3073b6d2477072690) || 1) && $this->valueHolder5b87d3073b6cd466078967 = $valueHolder5b87d3073b6cd466078967;

        if (isset(self::$publicProperties5b87d3073b6bd851848996[$name])) {
            return $this->valueHolder5b87d3073b6cd466078967->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b87d3073b6cd466078967;
    ...
    {
        $this->initializer5b87d3073b6d2477072690 && ($this->initializer5b87d3073b6d2477072690->__invoke($valueHolder5b87d3073b6cd466078967, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b87d3073b6d2477072690) || 1) && $this->valueHolder5b87d3073b6cd466078967 = $valueHolder5b87d3073b6cd466078967;
    ...
    {
        $this->initializer5b87d3073b6d2477072690 && ($this->initializer5b87d3073b6d2477072690->__invoke($valueHolder5b87d3073b6cd466078967, $this, '__isset', array('name' => $name), $this->initializer5b87d3073b6d2477072690) || 1) && $this->valueHolder5b87d3073b6cd466078967 = $valueHolder5b87d3073b6cd466078967;
    ...
    {
        $this->initializer5b87d3073b6d2477072690 && ($this->initializer5b87d3073b6d2477072690->__invoke($valueHolder5b87d3073b6cd466078967, $this, '__unset', array('name' => $name), $this->initializer5b87d3073b6d2477072690) || 1) && $this->valueHolder5b87d3073b6cd466078967 = $valueHolder5b87d3073b6cd466078967;
    ...
    {
        $this->initializer5b87d3073b6d2477072690 && ($this->initializer5b87d3073b6d2477072690->__invoke($valueHolder5b87d3073b6cd466078967, $this, '__clone', array(), $this->initializer5b87d3073b6d2477072690) || 1) && $this->valueHolder5b87d3073b6cd466078967 = $valueHolder5b87d3073b6cd466078967;

        $this->valueHolder5b87d3073b6cd466078967 = clone $this->valueHolder5b87d3073b6cd466078967;
    }

    public function __sleep()
    {
        $this->initializer5b87d3073b6d2477072690 && ($this->initializer5b87d3073b6d2477072690->__invoke($valueHolder5b87d3073b6cd466078967, $this, '__sleep', array(), $this->initializer5b87d3073b6d2477072690) || 1) && $this->valueHolder5b87d3073b6cd466078967 = $valueHolder5b87d3073b6cd466078967;

        return array('valueHolder5b87d3073b6cd466078967');
    }
    ...
    {
        return $this->initializer5b87d3073b6d2477072690;
    }
    ...
    {
        return $this->initializer5b87d3073b6d2477072690 && ($this->initializer5b87d3073b6d2477072690->__invoke($valueHolder5b87d3073b6cd466078967, $this, 'initializeProxy', array(), $this->initializer5b87d3073b6d2477072690) || 1) && $this->valueHolder5b87d3073b6cd466078967 = $valueHolder5b87d3073b6cd466078967;
    }
    ...
    {
        return null !== $this->valueHolder5b87d3073b6cd466078967;
    }
    ...
    {
        return $this->valueHolder5b87d3073b6cd466078967;
    }
